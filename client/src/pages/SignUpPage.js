            ...
            <div className="SignUp">
                <div className="layer">
                    <form onSubmit={this.onFormSubmit} className="form-login">
                        ...
                        <div className="form-group">
                            <i className="fa fa-key"></i>
                            <input type="password" placeholder="Confirm Password" className="form-control" name="confirmPassword" value={this.state.confirmPassword} onChange={this.onFieldChange}></input>
                        </div>
